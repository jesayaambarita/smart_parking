...
<head>
    ...
    <title>Smart Parking Update Pengguna
    </title>
    <!-- Bootstrap CSS -->
                    ...
                    <div class="">
                        <div class="card" style="min-height: 485px">
                            ...
                            <div class="card-content table-responsive">
                                ...
                                $sql = mysqli_query($connect, "SELECT * FROM tb_pengguna WHERE id_pengguna='$_GET[id_pengguna]'");
                                $data = mysqli_fetch_array($sql);
                                ?>
                                <form action="update_tb_mhs.php?id_pengguna=<?php echo $data['id_pengguna']; ?>" method="POST">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="jenis_kelamin" name="jenis_kelamin" value="<?php echo $data['jenis_kelamin']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Email</label>
                                        <input type="email" class="form-control" id="email_mhs" name="email" value="<?php echo $data['email']; ?>" required>
                                    </div>
                                    <div class="mb-3">
